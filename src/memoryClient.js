...
export const memoryApi = {
  ...
  plan: (code, goal, operatingBrief, niche) => request(code, "/../plan", { method: "POST", timeoutMs: 25000, body: JSON.stringify({ goal, operatingBrief, niche }) }),
  ...
  buildRoadmap: (code, goal) => request(code, "/../roadmap", { method: "POST", timeoutMs: 25000, body: JSON.stringify({ goal }) }),
};
